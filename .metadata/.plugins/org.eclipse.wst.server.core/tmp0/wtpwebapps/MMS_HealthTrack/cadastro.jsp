...
<head>    
    ...
    <link href="resources/css/estilocadastro.css" rel="stylesheet">
            ...
            <div class="row main">
                <div class="main-login main-center">
                    <form class="form-horizontal" method="post" action="#">
                        ...
                        <div class="form-group ">
                           <a href="painel.jsp"><button type="button" class="btn btn-primary btn-lg btn-block login-button">Registrar</button></a>
                        </div>
                    </form>
                </div>
            </div>
